...
(function($) {
  ...
  defaults = {
    ...
    inputs: {
      ...
      paginationLinkPlacementAfter: 'after',
  ...
  function PaginationPerPage(obj, settings) {
    ...
    this.create = function() {
      ...
      for (var i = 0, len = settings.dataset.perPageOptions.length; i < len; i++) {
        ...
        if (number != 99999) {$select.append('<option value="' + number + '" ' + selected + '>' + number + '</option>');}
        else                  {$select.append('<option value="' + number + '" ' + selected + '>Tous</option>');}
      }
