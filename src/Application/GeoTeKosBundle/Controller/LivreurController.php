...
use Application\GeoTeKosBundle\Entity\Livreur;
...
class LivreurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $livreurs = $em->getRepository('ApplicationGeoTeKosBundle:Livreur')->findAll();
    ...
    {
        $livreur = new Livreur();
        $form = $this->createForm('Application\GeoTeKosBundle\Form\LivreurType', $livreur);
    ...
    {
        $deleteForm = $this->createDeleteForm($livreur);
        $editForm = $this->createForm('Application\GeoTeKosBundle\Form\LivreurType', $livreur);
